    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-text mx-3">Çamaşırhane Sistemi</div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="musteriler.php">Müşteri Listesi</a>
                </div>
            </div>
        </li>
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="randevular.php">Randevu Listesi</a>
        </div>
    </div>
</li>

<li class="nav-item">
    <a class="nav-link" href="anket.php">
        <i class="fas fa-user"></i>
        <span>Müşteri Analizi</span></a>
    </li>
